...
#define DYNAMIC_PITCH_DEFINED		0x00080000
#define MONO_RENDERING			0x00100000
#define ALL_DEFINED			(CONE_DEFINED|INDOOR_DEFINED|OCCLUSION_DEFINED|DYNAMIC_PITCH_DEFINED|MONO_RENDERING)

    /* SCENE */
#define DISTQUEUE_CHANGED		0x10000000
#define REVERB_CHANGED			0x20000000
#define DISTDELAY_CHANGED		0x40000000
